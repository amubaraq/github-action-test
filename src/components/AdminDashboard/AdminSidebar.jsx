...
const AdminSidebar = () => {
  ...
  const sidebarLinks = [
    { path: "/Admin/Dashboard", icon: FaHome, label: "My Dashboard" },
    { path: "/Admin/profile", icon: IoPerson, label: "My Profile" },
    {
    ...
    },
    {
      ...
      icon: ListCheck,
      label: "Prominent People Request",
    },
    {
      path: "/Admin/AllRunningAds",
      icon: FaBullhorn,
