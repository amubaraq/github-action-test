...
import { ListCheck, UsersIcon } from "lucide-react";
...
const SuperAdminSidebar = () => {
  ...
  const sidebarLinks = [
    ...
    { path: "/SuperAdmin/profile", icon: IoPerson, label: "My Profile" },
    {
    ...
    },
    {
      ...
      icon: ListCheck,
      label: "All Business/Branch",
    },
    {
      path: "/SuperAdmin/AllRunningAds",
      icon: FaBullhorn,
      label: "All Running Ads",
    },
    {
      ...
      <div
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-5">
            ...
            {!isCollapsed && (
              <p className="text-sm text-blue-200 mb-6">SuperAdmin Dashboard</p>
            )}
            {!isSmallScreen && (
              <div className="flex items-center">
                <span className="mb-2">
